...
type DeParaTime = { dono: string; nome_time: string; jogadores: DeParaJogador[] };
...
const extras: DeParaJogador[] = [
  { atleta_id: 39656,  nome_csv: "Alan Franco (Atlético-MG)", apelido_api: "Alan Franco",  clube: "Atlético-MG",  clube_id: 234, posicao: "Meia",     posicao_id: 4, escalacao: "Sim" },
  { atleta_id: 109573, nome_csv: "Martinelli",                apelido_api: "Martinelli",   clube: "Fluminense",   clube_id: 266, posicao: "Meia",     posicao_id: 4, escalacao: "Não" },
  { atleta_id: 99440,  nome_csv: "Baralhas",                  apelido_api: "Baralhas",      clube: "Vitória",      clube_id: 285, posicao: "Meia",     posicao_id: 4, escalacao: "Não" },
  { atleta_id: 108133, nome_csv: "Isidro Pitta",              apelido_api: "Isidro Pitta",  clube: "Bragantino",   clube_id: 288, posicao: "Atacante", posicao_id: 5, escalacao: "Sim" },
  { atleta_id: 104519, nome_csv: "Camilo",                    apelido_api: "Camilo",        clube: "Chapecoense",  clube_id: 275, posicao: "Meia",     posicao_id: 4, escalacao: "Não" },
  { atleta_id: 42135,  nome_csv: "Willian",                   apelido_api: "Willian",       clube: "Grêmio",       clube_id: 284, posicao: "Meia",     posicao_id: 4, escalacao: "Sim" },
];
...
const csv = await Deno.readTextFile("./static/players/CARTOLA V2 - 1. ELENCO.csv");
...
console.log("\n=== TIMES E CONTAGEM ===");
for (const t of times) console.log(`${t.nome_time}: ${t.jogadores.length} jogadores`);
...
await Deno.writeTextFile("./static/de_para_jogadores.json", JSON.stringify({ times }, null, 2));
